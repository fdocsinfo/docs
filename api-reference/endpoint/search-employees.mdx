...
- This endpoint will return a unique **`request_id`** to let you track the progress via the [Check Search Status](https://fdocs.info/api-reference/endpoint/check-search-status) endpoint.
